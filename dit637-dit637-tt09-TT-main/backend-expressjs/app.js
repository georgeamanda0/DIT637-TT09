...
// OLD Codeblock with CORS configuration that can error with some requests, especially POST requests.
// const corsOptions = {
//   origin: '*',
...
// New CORS configuration that handles preflight requests and allows all origins, methods, and headers.
app.use((req, res, next) => {
  ...
  // Intercept preflight OPTIONS requests instantly
